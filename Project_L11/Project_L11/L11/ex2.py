...
NCBI_EMAIL = "bontasadrian03@gmail.com"  # put your real email here

# NCBI nucleotide accessions (examples – replace with what teacher gave you)
# e.g. influenza segment or full genome and SARS-CoV-2 reference
...
def print_alignment(a1: str, a2: str, max_width: int = 80):
    ...
    length = max(len(a1.replace("-", "")), 1)
    similarity = 100 * matches / length
...
def stepwise_alignment(seq1: str, seq2: str, chunk_size: int = CHUNK_SIZE):
    ...
    This is the "in-between layer" mentioned in the task:
